    ...
    <div className="flex flex-col border-r bg-background w-52 sticky top-0">
      ...
      <div className="flex-1 overflow-y-auto py-4 pr-4 space-y-6">
        ...
        <SidebarSection title="Templates">
          <SidebarItem href="/workspace/campaigns" icon={Megaphone}>
            Campaigns
          </SidebarItem>
          <SidebarItem href="/workspace/utm-templates" icon={Tag}>
            UTM
          </SidebarItem>
        </SidebarSection>

        <SidebarSection title="Organization">
          <SidebarItem href="/workspace/groups" icon={Users}>
            Groups
          </SidebarItem>
          <SidebarItem href="/workspace/tags" icon={Tag}>
            Tags
          </SidebarItem>
        </SidebarSection>
      </div>
