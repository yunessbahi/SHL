							...
							<tr key={l.id} className="border-t">
								...
								<td className="p-2">
									<div className="flex gap-2">
										<Link href={`/links/${l.id}/targets`} className="text-indigo-600 underline">Targets</Link>
										<Link href={`/links/${l.id}/preview`} className="text-indigo-600 underline">Preview</Link>
									</div>
								</td>
							</tr>
						))}
